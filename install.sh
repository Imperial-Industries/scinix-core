...
sudo snap install vscode-insiders --classic
...
sudo snap install ark --candidate
...
sudo snap install ubuntu-newsblur --edge
...
sudo snap install sirrujak-sciencefair
